...
public class LoginTest {
	...
	public void validatUserNameEmptyMSG() {
		...
		String ActualMSG=loginpage.validateUsernameErrorMSG(usernameerrormsg);
		 Assert.assertEquals(ActualMSG,usernameerrormsg,"username empty");
	...
	public void validatPasswordEmptyMSG() {
		...
		loginpage.pressLoginBotton();
		String ActualMSG=loginpage.validatePasswordeErrorMSG(passworderrormsg);
		Assert.assertEquals(ActualMSG, passworderrormsg, "password empty");
		 loginpage.closeErrorMessage();
	}
	...
	public void validatWrongpasswordtoLogin() {
		...
		loginpage.pressLoginBotton();
		String ActualMSG=loginpage.validateusernmeorPasswordwrongMSG(usernamorpasswordwrongmsg);
		Assert.assertEquals(ActualMSG, usernamorpasswordwrongmsg, "username empty");
		 loginpage.closeErrorMessage();
	}
