...
public class LoginPage {
	...
	public String  validateUsernameErrorMSG(String ExpectedMsg) {
		
		wait.until(ExpectedConditions.visibilityOf(usernameemptymsgElement));
	
		return usernameemptymsgElement.getText();
	...
	public String validatePasswordeErrorMSG(String ExpectedMsg) {
		
		wait.until(ExpectedConditions.visibilityOf(passwordemptymsgElement));
		return passwordemptymsgElement.getText();
	...
	public String validateusernmeorPasswordwrongMSG(String ExpectedMsg) {
		
		wait.until(ExpectedConditions.visibilityOf(usernameorpasswordwrongElement));
		return usernameorpasswordwrongElement.getText();
